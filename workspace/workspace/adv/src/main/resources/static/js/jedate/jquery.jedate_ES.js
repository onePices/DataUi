...
;(function(root, factory) {
    ...
    jet.returnDate = function(obj, format, dateval) {
        ...
        var setdate = new Date(narr[0]+parseInt(sparr[0]||00), narr[1]+parseInt(sparr[1]||00)-1, narr[2]+parseInt(sparr[2]||00), narr[3]+parseInt(sparr[3]||00), narr[4]+parseInt(sparr[4]||00), narr[5]+parseInt(sparr[5]||00)),
            ...
            eachYearMonth =function (YY, ymlen) {
                ...
                if (ymlen == 12) {
                    $.each(lang.month, function(i, val) {
                        ...
                        // (val+(lang.name == "cn" ? "":""))
                        ymStr += "<li class='"+ mcls +"' mm='" + val + "'>" + lang.monthEn[i] + "</li>";
                    });
