...
//		//接口路径，必须更改成有效的地址
//		String url = "http://127.0.0.1:8090/ListenSdkService/sdk/getDeviceList.php";
//		
...
//	}
	...
	public void sendProgram() {
		//接口路径，必须更改成有效的地址
		String url = "http://127.0.0.1:8080/ListenSdkService/sdk/lsPublishProgram.fgl";
		String devCode = "QC202006190005";
...
//	
	...
	public void getDeviceAndImage(){
		//接口路径，必须更改成有效的地址
		String url = "http://39.99.166.20:8080/ListenSdkService/sdk/getMapDeviceList.php";
	...
	public static void main(String[] args) {  
		CardProgramTest.getProgramContent();
